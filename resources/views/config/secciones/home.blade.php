                ...
                <div class="col position-relative">
                    <div class="slider_imagenes px-0">
                        @foreach ($sliders as $slider)
                            <div>
                                <img class="principal-slider img-fluid" src="{{ asset('img/photos/sliders/'.$slider->imagen) }}" alt="">
                            </div>
                        @endforeach 
                    </div>
                    <div class="col-12 position-absolute top-0 bottom-0 start-0 bloqueo-slider d-flex align-items-center justify-content-center">
                        <a href="{{ route('seccion.show', ['slug' => 'sliders']) }}" class="btn fs-1 text-decoration-none">Editar en Sliders</a>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
        ...
        <div class="container-fluid" style="background-color: #F6F6F6;">
            <div class="row">
                <div class="col position-relative">
                    ...
                    <div class="col-12 position-absolute top-0 bottom-0 start-0 bloqueo-slider d-flex align-items-center justify-content-center">
                        <a href="{{ route('seccion.show', ['slug' => 'empresas']) }}" class="btn fs-1 text-decoration-none">Editar en Empresas</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12 mx-auto">
                            ...
                            <div class="row">
                                <div class="col pt-5 position-relative">
                                    ...
                                    <div class="col-12 position-absolute top-0 bottom-0 start-0 bloqueo-slider d-flex align-items-center justify-content-center">
                                        <a href="{{ route('seccion.show', ['slug' => 'servicios']) }}" class="btn fs-1 text-decoration-none">Editar en Servicios</a>
                                    </div>
                                </div>
                            </div>
                        </div>
